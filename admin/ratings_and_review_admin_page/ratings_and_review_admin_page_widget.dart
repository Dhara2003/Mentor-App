...
import 'ratings_and_review_admin_page_model.dart';
export 'ratings_and_review_admin_page_model.dart';

class RatingsAndReviewAdminPageWidget extends StatefulWidget {
  const RatingsAndReviewAdminPageWidget({super.key});

  @override
  State<RatingsAndReviewAdminPageWidget> createState() =>
      _RatingsAndReviewAdminPageWidgetState();
}

class _RatingsAndReviewAdminPageWidgetState
    extends State<RatingsAndReviewAdminPageWidget> {
  late RatingsAndReviewAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RatingsAndReviewAdminPageModel());
