...
import 'notification_admin_page_model.dart';
export 'notification_admin_page_model.dart';

class NotificationAdminPageWidget extends StatefulWidget {
  const NotificationAdminPageWidget({super.key});

  @override
  State<NotificationAdminPageWidget> createState() =>
      _NotificationAdminPageWidgetState();
}

class _NotificationAdminPageWidgetState
    extends State<NotificationAdminPageWidget> {
  late NotificationAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationAdminPageModel());
