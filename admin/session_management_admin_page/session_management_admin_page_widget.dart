...
import 'session_management_admin_page_model.dart';
export 'session_management_admin_page_model.dart';

class SessionManagementAdminPageWidget extends StatefulWidget {
  const SessionManagementAdminPageWidget({super.key});

  @override
  State<SessionManagementAdminPageWidget> createState() =>
      _SessionManagementAdminPageWidgetState();
}

class _SessionManagementAdminPageWidgetState
    extends State<SessionManagementAdminPageWidget> {
  late SessionManagementAdminPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SessionManagementAdminPageModel());
