...
import 'mentor_profile5_copy_model.dart';
export 'mentor_profile5_copy_model.dart';

class MentorProfile5CopyWidget extends StatefulWidget {
  const MentorProfile5CopyWidget({super.key});

  @override
  State<MentorProfile5CopyWidget> createState() =>
      _MentorProfile5CopyWidgetState();
}

class _MentorProfile5CopyWidgetState extends State<MentorProfile5CopyWidget>
    with TickerProviderStateMixin {
  late MentorProfile5CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentorProfile5CopyModel());
