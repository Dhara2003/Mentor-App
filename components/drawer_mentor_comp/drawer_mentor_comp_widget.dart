...
import 'drawer_mentor_comp_model.dart';
export 'drawer_mentor_comp_model.dart';

class DrawerMentorCompWidget extends StatefulWidget {
  const DrawerMentorCompWidget({
    super.key,
  ...
  @override
  State<DrawerMentorCompWidget> createState() => _DrawerMentorCompWidgetState();
}

class _DrawerMentorCompWidgetState extends State<DrawerMentorCompWidget>
    with TickerProviderStateMixin {
  late DrawerMentorCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrawerMentorCompModel());
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.goNamed(
                        'MentorProfilePage',
                        queryParameters: {
                          'selectedPageIndex': serializeParam(
                            2,
                            ParamType.int,
                          ),
                        }.withoutNulls,
