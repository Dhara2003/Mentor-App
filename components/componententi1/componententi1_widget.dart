...
import 'componententi1_model.dart';
export 'componententi1_model.dart';

class Componententi1Widget extends StatefulWidget {
  const Componententi1Widget({
    super.key,
  ...
  @override
  State<Componententi1Widget> createState() => _Componententi1WidgetState();
}

class _Componententi1WidgetState extends State<Componententi1Widget> {
  late Componententi1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Componententi1Model());
