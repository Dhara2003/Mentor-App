...
import 'ratings_and_review_mentor_page_model.dart';
export 'ratings_and_review_mentor_page_model.dart';

class RatingsAndReviewMentorPageWidget extends StatefulWidget {
  const RatingsAndReviewMentorPageWidget({super.key});

  @override
  State<RatingsAndReviewMentorPageWidget> createState() =>
      _RatingsAndReviewMentorPageWidgetState();
}

class _RatingsAndReviewMentorPageWidgetState
    extends State<RatingsAndReviewMentorPageWidget> {
  late RatingsAndReviewMentorPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RatingsAndReviewMentorPageModel());
