...
import 'entrepreneurlist_page_model.dart';
export 'entrepreneurlist_page_model.dart';

class EntrepreneurlistPageWidget extends StatefulWidget {
  const EntrepreneurlistPageWidget({super.key});

  @override
  State<EntrepreneurlistPageWidget> createState() =>
      _EntrepreneurlistPageWidgetState();
}

class _EntrepreneurlistPageWidgetState
    extends State<EntrepreneurlistPageWidget> {
  late EntrepreneurlistPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EntrepreneurlistPageModel());
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              'https://images.unsplash.com/photo-1588516903720-8ceb67f9ef84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxNXx8d29tZW58ZW58MHx8fHwxNzEzMjM0NDIxfDA&ixlib=rb-4.0.3&q=80&w=400',
                                              width: 65.0,
                                              height: 65.0,
                                              fit: BoxFit.cover,
                                            ),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  FlutterFlowIconButton(
                                                    borderColor:
                                                        const Color(0x001A1A24),
                                                    borderWidth: 1.0,
                                                    buttonSize: 31.0,
                                                    fillColor:
                                                        const Color(0x00E07A5F),
                                                    icon: const Icon(
                                                      Icons.star,
