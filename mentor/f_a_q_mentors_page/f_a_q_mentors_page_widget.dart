...
import 'f_a_q_mentors_page_model.dart';
export 'f_a_q_mentors_page_model.dart';

class FAQMentorsPageWidget extends StatefulWidget {
  const FAQMentorsPageWidget({super.key});

  @override
  State<FAQMentorsPageWidget> createState() => _FAQMentorsPageWidgetState();
}

class _FAQMentorsPageWidgetState extends State<FAQMentorsPageWidget> {
  late FAQMentorsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FAQMentorsPageModel());
