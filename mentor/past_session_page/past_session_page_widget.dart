...
import 'past_session_page_model.dart';
export 'past_session_page_model.dart';

class PastSessionPageWidget extends StatefulWidget {
  const PastSessionPageWidget({super.key});

  @override
  State<PastSessionPageWidget> createState() => _PastSessionPageWidgetState();
}

class _PastSessionPageWidgetState extends State<PastSessionPageWidget> {
  late PastSessionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PastSessionPageModel());
