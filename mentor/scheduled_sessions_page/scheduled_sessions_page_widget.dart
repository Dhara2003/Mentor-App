...
import 'scheduled_sessions_page_model.dart';
export 'scheduled_sessions_page_model.dart';

class ScheduledSessionsPageWidget extends StatefulWidget {
  const ScheduledSessionsPageWidget({super.key});

  @override
  State<ScheduledSessionsPageWidget> createState() =>
      _ScheduledSessionsPageWidgetState();
}

class _ScheduledSessionsPageWidgetState
    extends State<ScheduledSessionsPageWidget> {
  late ScheduledSessionsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScheduledSessionsPageModel());
