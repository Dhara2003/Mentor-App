...
import 'ratings_and_review_entrepreneur_page_model.dart';
export 'ratings_and_review_entrepreneur_page_model.dart';

class RatingsAndReviewEntrepreneurPageWidget extends StatefulWidget {
  const RatingsAndReviewEntrepreneurPageWidget({super.key});

  @override
  State<RatingsAndReviewEntrepreneurPageWidget> createState() =>
      _RatingsAndReviewEntrepreneurPageWidgetState();
}

class _RatingsAndReviewEntrepreneurPageWidgetState
    extends State<RatingsAndReviewEntrepreneurPageWidget> {
  late RatingsAndReviewEntrepreneurPageModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => RatingsAndReviewEntrepreneurPageModel());
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: Image.asset(
                      'assets/images/Rating_&_review.png',
                    ).image,
                  ),
                ),
                child: Column(
