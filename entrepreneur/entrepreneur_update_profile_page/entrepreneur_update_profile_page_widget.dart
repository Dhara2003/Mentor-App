...
import 'entrepreneur_update_profile_page_model.dart';
export 'entrepreneur_update_profile_page_model.dart';

class EntrepreneurUpdateProfilePageWidget extends StatefulWidget {
  const EntrepreneurUpdateProfilePageWidget({
    super.key,
  ...
  @override
  State<EntrepreneurUpdateProfilePageWidget> createState() =>
      _EntrepreneurUpdateProfilePageWidgetState();
}

class _EntrepreneurUpdateProfilePageWidgetState
    extends State<EntrepreneurUpdateProfilePageWidget> {
  late EntrepreneurUpdateProfilePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EntrepreneurUpdateProfilePageModel());
