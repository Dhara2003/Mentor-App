...
import 'ideasubmission_model.dart';
export 'ideasubmission_model.dart';

class IdeasubmissionWidget extends StatefulWidget {
  const IdeasubmissionWidget({
    super.key,
  ...
  @override
  State<IdeasubmissionWidget> createState() => _IdeasubmissionWidgetState();
}

class _IdeasubmissionWidgetState extends State<IdeasubmissionWidget> {
  late IdeasubmissionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IdeasubmissionModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          wrapWithModel(
                            model: _model.componententi1Model,
                            updateCallback: () => setState(() {}),
                            child: const Componententi1Widget(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 15.0, 0.0, 0.0),
                                    child: Text(
                                      'Enter your business idea here in short (one liner)..',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    15.0, 20.0, 0.0, 0.0),
                                child: Text(
                                  'Describe your business idea here...',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Readex Pro',
