...
import 'reschedulesession3_model.dart';
export 'reschedulesession3_model.dart';

class Reschedulesession3Widget extends StatefulWidget {
  const Reschedulesession3Widget({super.key});

  @override
  State<Reschedulesession3Widget> createState() =>
      _Reschedulesession3WidgetState();
}

class _Reschedulesession3WidgetState extends State<Reschedulesession3Widget> {
  late Reschedulesession3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Reschedulesession3Model());
                    ...
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            'Lorem ipsum dolor sit amet consectetur. Mattis urna sodales at odio ac arcu sollicitudin sit. Ultricies faucibus pretium sed at feugiat egestas vel risus in. Lobortis cursus id augue vitae orci. Aliquet ut ultricies pellentesque feugiat sem nunc nibh sit at.',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Poppins',
                                  color: const Color(0xFFE8DC77),
                                  fontSize: 12.0,
                                  letterSpacing: 0.0,
                                ),
                          ),
