...
import 'session_management_entrepreneur_page_model.dart';
export 'session_management_entrepreneur_page_model.dart';

class SessionManagementEntrepreneurPageWidget extends StatefulWidget {
  const SessionManagementEntrepreneurPageWidget({super.key});

  @override
  State<SessionManagementEntrepreneurPageWidget> createState() =>
      _SessionManagementEntrepreneurPageWidgetState();
}

class _SessionManagementEntrepreneurPageWidgetState
    extends State<SessionManagementEntrepreneurPageWidget> {
  late SessionManagementEntrepreneurPageModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => SessionManagementEntrepreneurPageModel());
                        ...
                        children: [
                          wrapWithModel(
                            ...
                            child: const SessionManagementCardTop1Widget(
                              text: 'Upcoming sessions for this month',
                              num: '23',
                          ...
                          wrapWithModel(
                            ...
                            child: const SessionManagementCardBottom1Widget(
                              text: 'Upcoming sessions for this week ',
                              num: '3',
