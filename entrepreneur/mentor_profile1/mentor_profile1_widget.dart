...
import 'mentor_profile1_model.dart';
export 'mentor_profile1_model.dart';

class MentorProfile1Widget extends StatefulWidget {
  const MentorProfile1Widget({super.key});

  @override
  State<MentorProfile1Widget> createState() => _MentorProfile1WidgetState();
}

class _MentorProfile1WidgetState extends State<MentorProfile1Widget>
    with TickerProviderStateMixin {
  late MentorProfile1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentorProfile1Model());
