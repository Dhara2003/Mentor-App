...
import 'ressession_model.dart';
export 'ressession_model.dart';

class RessessionWidget extends StatefulWidget {
  const RessessionWidget({super.key});

  @override
  State<RessessionWidget> createState() => _RessessionWidgetState();
}

class _RessessionWidgetState extends State<RessessionWidget> {
  late RessessionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RessessionModel());
