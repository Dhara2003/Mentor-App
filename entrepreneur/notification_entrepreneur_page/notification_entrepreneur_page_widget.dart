...
import 'notification_entrepreneur_page_model.dart';
export 'notification_entrepreneur_page_model.dart';

class NotificationEntrepreneurPageWidget extends StatefulWidget {
  const NotificationEntrepreneurPageWidget({super.key});

  @override
  State<NotificationEntrepreneurPageWidget> createState() =>
      _NotificationEntrepreneurPageWidgetState();
}

class _NotificationEntrepreneurPageWidgetState
    extends State<NotificationEntrepreneurPageWidget> {
  late NotificationEntrepreneurPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationEntrepreneurPageModel());
