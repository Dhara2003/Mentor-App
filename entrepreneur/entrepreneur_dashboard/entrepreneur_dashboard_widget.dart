...
import 'entrepreneur_dashboard_model.dart';
export 'entrepreneur_dashboard_model.dart';

class EntrepreneurDashboardWidget extends StatefulWidget {
  const EntrepreneurDashboardWidget({super.key});

  @override
  State<EntrepreneurDashboardWidget> createState() =>
      _EntrepreneurDashboardWidgetState();
}

class _EntrepreneurDashboardWidgetState
    extends State<EntrepreneurDashboardWidget> {
  late EntrepreneurDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EntrepreneurDashboardModel());
